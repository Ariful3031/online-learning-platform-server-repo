...
const DashBoardLayout = () => {
    ...
    return (
        <div className=' w-11/12 mx-auto md:grid md:grid-cols-5'>
            
            <aside className='left_aside min-h-50 border-2 border-gray-300 shadow-xl p-3'>
                <nav>
                    <NavLink className='btn btn-primary md:inline-block md:pt-2 hover:scale-105 mt-3 w-full' to='/dashboard/my_enrolled_course'>MyEnrolledCourse</NavLink>
            ...
            <aside className="right_aside md:col-span-4 border-2 border-gray-300 shadow-xl p-3">
