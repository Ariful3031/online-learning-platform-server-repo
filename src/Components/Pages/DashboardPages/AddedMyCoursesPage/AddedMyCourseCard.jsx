...
const AddedMyCourseCard = ({ course,setAddedCourses,AddedCourses }) => {
    ...
    // console.log(course)
    return (
        <div className='border-2 border-gray-100 p-4 bg-[#B9F8CF] shadow-md shadow-gray-400 my-3 md:my-2 lg:my-5 rounded-lg w-full'>
            <div className=''>
            ...
            <div className='grid grid-cols-2 my-2 gap-2'>
                <Link to={`/dashboard/my_added_course/update_course/${_id}`} className='btn bg-blue-800 text-white p-2 w-full dark:border-none hover:scale-105 '>Update</Link>
                <button onClick={() => handleDeleteButton(_id)} className='btn bg-red-500 text-white p-2 w-full dark:border-none hover:scale-105 '>Delete</button>
            </div>
