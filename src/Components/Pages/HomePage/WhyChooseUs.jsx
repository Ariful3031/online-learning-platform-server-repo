...
const WhyChooseUs = () => {
    return (
        <div className='w-11/12 mx-auto'>
            <h1 className='text-4xl font-semibold my-5 text-black w-[320px] mx-auto'>Why Choose Us</h1>
            <div className='grid grid-cols-3 md:grid-cols-4 justify-center text-center my-8 gap-3 sm:gap-5 md:gap-5'>
                <div className='border-2 border-gray-200 p-3 md:pb-5 w-full rounded-xl'>
